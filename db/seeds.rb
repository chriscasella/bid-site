...
bid1 = Bid.create(user_id: 10, auction_id: auction1, bid_quote: 30000, winning_bid: false)
bid2 = Bid.create(user_id: 11, auction_id: auction1, bid_quote: 50000, winning_bid: false)
