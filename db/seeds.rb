...
auction6 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
auction7 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now  + 14, user: user2)
auction8 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
auction9 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
auction10 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
auction11 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
auction12 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
