...
auction5 = Auction.create(name: "Phase I Site Assessment", location: "Easton, PA", description: "Phase I assessment services requested to stay within PADEP environmental compliance act. Report deliverable required to be submitted to PADEP on behalf of auctioneer. Assessment to determign environmental impacts or preexisting environmental contamination.", auction_start_date: DateTime.now, auction_close_date: DateTime.now + 14, user: user2)
